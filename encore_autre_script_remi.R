...
####### Ca c'est pour faire des plots avec des ellipses centrees en la moyenne de chaque cluster et representant sa variance

### Je ne suis pas sur de ces plots d'ellipses, il faut verifier que c'est pas n'importe quoi
